(function () {
  ...
  if (!document.querySelector("script[data-creditreports-analytics]")) {
    const analytics = document.createElement("script");
    analytics.src = "/js/analytics.js";
    analytics.dataset.creditreportsAnalytics = "true";
    document.head.appendChild(analytics);
  }

  const LOGIN = "https://platform.creditreports.dk";
  const SIGNUP =
    "https://platform.creditreports.dk/AspAndUserCreation.action?templateAspQueryKey=CreditAnalysis&popup=true";
  ...
  const COPY = {
    en: {
      ...
      footerTagline:
        "Credit risk reports and financial analysis for Danish companies.",
    ...
    da: {
      ...
      closeMenu: "Luk menu",
      footerTagline:
        "Kreditrapporter og finansiel analyse for danske virksomheder.",
    ...
    const links =
      locale === "da"
        ...
        : [
            ...
            [
              supportPath("en", "credit-risk-model-overview/"),
              text.modelOverview,
            ],
          ];
  ...
  function supportPath(locale, suffix = "") {
    if (locale === "da")
      return pagePath(
        "da",
        suffix ? `support/${suffix}` : "support/kreditrisiko/",
      );
  ...
  function riskManagementPath(locale) {
    return locale === "da"
      ? supportPath("da", "kreditrisiko/")
      : supportPath("en", "credit-risk-management/");
  }
  ...
  function buildNav() {
    ...
    const productActive = path.startsWith(`/${locale}/product`)
      ? " nav-link--active"
      : "";
    const supportActive = path.startsWith(`/${locale}/support`)
      ? " nav-link--active"
      : "";
    const desktopLinks =
      locale === "da"
      ...
      <a href="${pagePath(locale, "guides/")}" class="nav-link${path.startsWith("/da/guides") ? " nav-link--active" : ""}">Guides</a>
    ...
    const mobileLinks =
      locale === "da"
        ...
        <li><a href="${pagePath(locale, "guides/")}" class="nav-mobile-link">Guides</a></li>
    ...
    const actionHref =
      locale === "da"
        ? "/da/#koeb-rapport"
        : pagePath(locale, "create-account/");
    const actionLabel =
      locale === "da" ? "Find virksomhed" : text.createAccount;
  ...
  function initNav() {
    ...
    const setMenuOpen = (open) => {
      ...
      hamburger.setAttribute(
        "aria-label",
        open ? text.closeMenu : text.openMenu,
      );
